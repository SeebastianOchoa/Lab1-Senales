...
noiseuno = np.random.randn(len(t))/5 #generamos números aleatorios siguiendo una distribución normal estándar
...
powdos = powimpulso(noisedos) # extraemos la variable de potencia del ruido de a funcion
...
ampliartefac = 1 # esta variable almacena la amplitud del ruido 
